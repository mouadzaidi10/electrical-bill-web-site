...
<body>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card">
                    <div class="card-body text-center d-flex flex-column align-items-center">
                        <div class="bs-icon-xl bs-icon-circle shadow bs-icon my-4">
                        <div class=""><img class="img-fluid w-100" src="lib/img/illustrations/icons8-energy.svg" /></div>
                        </div>
                        <form action="route.php" method="post">
                            <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Email" required/></div>
                            <div class="mb-3"><input class="form-control" type="password" name="password" placeholder="Password" required/></div>
                            <div class="mb-3"><button class="btn btn-info shadow d-block w-100" type="submit" name="submit_login">Log in</button></div>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <?php
        if(isset($_SESSION['status']) && $_SESSION['status'] != '' && $_SESSION['status_code'] == 'error'){
            ?>
            <script>
                Swal.fire({
