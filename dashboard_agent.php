...
if (!isset($_SESSION['id']) || !isset($_SESSION['user_type']) || $_SESSION['user_type'] != 'agent') {
...
<head>
    ...
    <title>TP2 Web - Dashboard Agent</title>
...
<body>
    ...
    <!-- add new consommation annuelle modal start -->
    <div class="modal fade" id="addConsommationAnnuelleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  data-bs-backdrop="static" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Consommations Annuelle Ficher</h5>
      ...
      <form action="route.php" method="POST" id="add_employee_form" enctype="multipart/form-data">
        <div class="modal-body p-4 bg-light">
          ...
          <div class="my-2">
            <label for="ficher_conso_annua">Ficher</label>
            <input type="file" name="ficher_conso_annua" class="form-control" placeholder="Adresse" required>
          </div>
          
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <button type="submit" name="submit-add-ConsommationAnnuelle" id="add_employee_btn" class="btn btn-primary">Add Ficher</button>
        </div>
      </form>
    </div>
  </div>
</div>
<!-- add new consommation annuelle modal end -->
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span><img src="lib/img/illustrations/icons8-energy.svg"></span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link" href="dashboard_agent.php">Home</a></li>
                </ul>
      ...
      <div class="col-lg-8">
        <div class="card shadow">
          <div class="card-header bg-primary d-flex justify-content-between align-items-center">
            <h3 class="text-light">Les Consommations Annuelle</h3>
            <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addConsommationAnnuelleModal"><i
                class="bi-plus-circle me-2"></i>Add New Ficher</button>
          </div>
        </div>
      </div>
    </div>
