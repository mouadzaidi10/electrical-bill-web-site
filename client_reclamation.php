...
<body>
    ...
    <!-- add new Consommation modal start -->
    <div class="modal fade" id="addReclamationModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  data-bs-backdrop="static" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Reclamation</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="route.php" method="POST" id="add_employee_form" enctype="multipart/form-data">
        <div class="modal-body p-4 bg-light">
          <div class="my-2">
            <label for="category">Type Reclamation :</label>
            <select id="category" name="category" onchange="toggleOtherInput()" required>
          ...
          <div id="other_input" style="display: none;">
            <label for="other_category">Autre Category:</label>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="submit-add-reclamation" id="add_employee_btn" class="btn btn-info">Add Reclamation</button>
        </div>
      </form>
    </div>
  </div>
</div>
<!-- add new Consommation modal end -->
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span><img src="lib/img/illustrations/icons8-energy.svg"></span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="client_reclamation.php">Reclamation</a></li>
      ...
      <div class="col-lg-8">
        <div class="card shadow">
          <div class="card-header bg-info d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addReclamationModal"><i
                class="bi-plus-circle me-2"></i>Add New Reclamation</button>
          </div>
        </div>
      </div>
    </div>
